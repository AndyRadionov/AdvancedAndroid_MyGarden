...
public class PlantWateringService extends IntentService {
    ...
    public static void startUpdatePlantsWidget(Context context) {
        Intent intent = new Intent(context, PlantWateringService.class);
    ...
    private void handleActionUpdatePlantsWidgets() {
        ...
        int[] widgetsIds = widgetManager.getAppWidgetIds(new ComponentName(this, PlantWidgetProvider.class));
        PlantWidgetProvider.updatePlantWidgets(this, widgetManager, imgRes, widgetsIds);
    }
}
